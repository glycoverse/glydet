# Contributing to glydet

This outlines how to propose a change to glydet. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glydet", fork = TRUE)`.
...
Please note that the glydet project is released with a [Contributor Code
of Conduct](https://glycoverse.github.io/glydet/dev/CODE_OF_CONDUCT.md).
