...
.make_trait_sys_prompt <- function(description = NULL, custom_mp = NULL) {
  ...
  paste0(
    ...
    "Each function has an optional `within` parameter to restrict the calculation to a specific glycan subset, which is a logical expression.\n",
    "Only include `within` when the description names a subset; otherwise omit it. Never use `within = TRUE`.\n",
